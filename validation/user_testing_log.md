...
3. **Trần Đình Trọng** (`2A202602812` - Lớp 3A, Phòng E403) — Người dùng ngoài nhóm (Nhóm khác cụm).
4. **Hoàng Minh Đức** (`2A202602445` - Lớp 3B, Phòng E402) — Người dùng ngoài nhóm (Lớp 3B).
5. **Đỗ Quỳnh Anh** (`2A202602678` - Lớp 3A, Phòng E403) — Người dùng ngoài nhóm (Nhóm khác phòng).
