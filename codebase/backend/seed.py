...
LESSON_ID = "seed-transformer-demo"  # mã bộ slide giả cho data demo

SEED_ACTIVITIES = [
    {
        "session_id": SESSION_ID, "lesson": LESSON, "lesson_id": LESSON_ID, "slide": 12, "type": "question",
    ...
    {
        "session_id": SESSION_ID, "lesson": LESSON, "lesson_id": LESSON_ID, "slide": 12, "type": "bookmark",
        "highlight": "Query, Key, Value",
    },
    {
        "session_id": SESSION_ID, "lesson": LESSON, "lesson_id": LESSON_ID, "slide": 12, "type": "note",
        "highlight": "Self-attention computes the attention weights between tokens using Query, Key, and Value matrices.",
        "note": "Chưa hiểu rõ bản chất 3 ma trận Q, K, V khác nhau thế nào", "rating": 2,
    },
    {
        "session_id": SESSION_ID, "lesson": LESSON, "lesson_id": LESSON_ID, "slide": 13, "type": "question",
        "highlight": "Multi-head attention runs several attention heads in parallel.",
        "question": "Multi-head attention là gì?",
    },
    {
        "session_id": SESSION_ID, "lesson": LESSON, "lesson_id": LESSON_ID, "slide": 14, "type": "note",
    ...
    {
        "session_id": SESSION_ID, "lesson": LESSON, "lesson_id": LESSON_ID, "slide": 13, "type": "note",
